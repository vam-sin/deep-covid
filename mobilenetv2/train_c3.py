...
# model
num_classes = 3
mv2 = keras.applications.MobileNetV2(include_top = False, weights = "imagenet")
...
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('mobilenetv2_c3.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
...
# with tf.device('/cpu:0'):
print("Evaluating")
model = keras.models.load_model('mobilenetv2_c3.h5')
