...
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('squeezenet_new_c3.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
...
# Evaluate
model = keras.models.load_model('squeezenet_new_c3.h5')
